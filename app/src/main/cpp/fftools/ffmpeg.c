...
#include "arm64-v8a/libavdevice/avdevice.h"
#include "arm64-v8a/libswresample/swresample.h"
#include "arm64-v8a/libavutil/opt.h"
#include "arm64-v8a/libavutil/channel_layout.h"
#include "arm64-v8a/libavutil/parseutils.h"
#include "arm64-v8a/libavutil/samplefmt.h"
#include "arm64-v8a/libavutil/fifo.h"
#include "arm64-v8a/libavutil/hwcontext.h"
#include "arm64-v8a/libavutil/internal.h"
#include "arm64-v8a/libavutil/intreadwrite.h"
#include "arm64-v8a/libavutil/dict.h"
#include "arm64-v8a/libavutil/display.h"
#include "arm64-v8a/libavutil/mathematics.h"
#include "arm64-v8a/libavutil/pixdesc.h"
#include "arm64-v8a/libavutil/avstring.h"
#include "arm64-v8a/libavutil/libm.h"
#include "arm64-v8a/libavutil/imgutils.h"
#include "arm64-v8a/libavutil/timestamp.h"
#include "arm64-v8a/libavutil/bprint.h"
#include "arm64-v8a/libavutil/time.h"
#include "arm64-v8a/libavutil/thread.h"
#include "arm64-v8a/libavutil/threadmessage.h"
#include "arm64-v8a/libavcodec/mathops.h"
#include "arm64-v8a/libavformat/os_support.h"

# include "arm64-v8a/libavfilter/avfilter.h"
# include "arm64-v8a/libavfilter/buffersrc.h"
# include "arm64-v8a/libavfilter/buffersink.h"
...
#include "arm64-v8a/libavutil/avassert.h"
...
int main(int argc, char **argv)
{
    ...
    __android_log_print(ANDROID_LOG_INFO,"FFmpeg","%"PRIu64" frames successfully decoded, %"PRIu64" decoding errors\n",
                        decode_error_stat[0], decode_error_stat[1]);

    if ((decode_error_stat[0] + decode_error_stat[1]) * max_error_rate < decode_error_stat[1])
        exit_program(69);
    __android_log_print(ANDROID_LOG_INFO,"FFmpeg","return code:%d",main_return_code);
